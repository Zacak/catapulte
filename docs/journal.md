...
Création du repo GitHub (https://github.com/Zacak/catapulte)
Mise en place du journal de bord sur le site
Analyse du cahier des charges (https://doc.makerspace-amiens.fr/workshops/medieval-challenge/concepts/medieval-challenge/informations/)
...
Base:170x170x5mm
Bras:150mm
Distance de l’axe à la balle :125mm
